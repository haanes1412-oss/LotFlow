...
export const FIELD_GLOSSARY = {
  ...
  // ——— Steam ———
  steam_level: { label: "Уровень Стим", hint: "Уровень профиля Стим" },
  steam_games_count: { label: "Игры в Стим", hint: "Количество игр в библиотеке" },
  hours_played: { label: "Часы в играх", hint: "Суммарно сыграно часов" },
  inventory_value: { label: "Стоимость инвентаря", hint: "Оценочная стоимость предметов" },
  // ——— Minecraft ———
